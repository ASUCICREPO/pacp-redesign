...
**When operating within AI-DLC's Code Generation stage:** Follow AI-DLC's per-unit test generation plan. AI-DLC includes test steps (unit testing for business logic, API layer, etc.) as mandatory checkboxes within each unit's code generation plan. Execute these as planned.
...
- Figma design URL → Use Figma Power to extract design context
